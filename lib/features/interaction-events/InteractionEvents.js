 ...
 */
function InteractionEvents(eventBus, elementRegistry, defaultRenderer, styles) {
  ...
  var createLine = defaultRenderer.createLine,
      updateLine = defaultRenderer.updateLine;
...
InteractionEvents.$inject = [ 'eventBus', 'elementRegistry', 'defaultRenderer', 'styles' ];
